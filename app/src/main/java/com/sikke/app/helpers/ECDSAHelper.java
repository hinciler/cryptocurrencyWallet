...
import static com.sikke.app.helpers.AppHelper.hexStringToByteArray;
...
public class ECDSAHelper {
    ...
    public String generatePublicKey() throws Exception{
        ...
        byte[] bytePub = hexStringToByteArray(bcPub);
    ...
    public  String generatePrivateKey() throws Exception {
        ...
        byte[] bytePvt = hexStringToByteArray(strPrivate);
    ...
    public static PublicKey importPublicKey(String publicKey) throws Exception{
        ...
        java.security.spec.ECPoint w = new java.security.spec.ECPoint(new BigInteger(1, Arrays.copyOfRange(public_decode, 0, 32)), new BigInteger(1, Arrays.copyOfRange(public_decode, 32, 64)));
